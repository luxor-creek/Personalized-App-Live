...
const PersonalizedHeroSection = ({ 
  ...
  const getHeadline = () => {
    if (firstName) {
      return (
        <>
          {firstName}, here's our latest officer recruitment video
          <span className="text-gradient block mt-2">for you to review.</span>
        </>
      );
    }
    return (
      ...
      <div className="container mx-auto px-4 py-12 lg:py-20 relative z-10">
        ...
        <div className="max-w-5xl mx-auto text-center mb-12 lg:mb-16">
          <p className="text-primary font-medium tracking-wider uppercase mb-4 animate-fade-up">
            {company ? `Prepared for ${company}` : "Police Recruitment Video Demo"}
          </p>
